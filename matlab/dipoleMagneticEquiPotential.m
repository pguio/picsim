function A = dipoleMagneticEquiPotential(m, rm, r, a0)
% function A = dipoleMagneticEquiPotential(m, rm, r, a0)
%
%    m  : magnetic moment vector
%    rm : position of the magnetic moment
%    a0 : Potential of the magnetic streamline
%    A  : dipole magnetic potential (cell array of length(m), each cell is
%         an array of size(r))

%
% $Id: dipoleMagneticEquiPotential.m,v 1.2 2011/03/26 15:36:05 patrick Exp $
%
