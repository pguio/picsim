function [phi,solver]=solver2d(rho,solver)
% function phi=solve_rho_to_phi(rho,solver)

%
% $Id: solver2d.m,v 1.5 2011/03/26 15:36:05 patrick Exp $
%
