function [particles,scheduler]=picsim2d(initfile,varargin)
% function [particles,scheduler]=picsim2d(initfile,varargin)

%
% $Id: picsim2d.m,v 1.8 2011/03/26 15:36:05 patrick Exp $
%
...
[scheduler,particles]=feval(['picsim_' initfile '_2d'],varargin{:});
...
if scheduler.tracer,
  tracer = tracer_init(particles{1},scheduler);
end
...
for i=1:scheduler.maxiter,
	...
	particles_plot(particles,scheduler,111);
	if scheduler.tracer,
	  tracer=particles_tracer(tracer,particles{1},scheduler,111);
	end
